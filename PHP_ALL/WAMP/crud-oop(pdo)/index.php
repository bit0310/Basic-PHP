...
<section class="p">
<P><b>ENTER STUDENT INFORMATION</b><span style="float:right"><a href="index.php">For Student</a> || <a href="teacher.php">For Teacher</a></span></P>
</section>
...
<input type="hidden" name="id" value="<?php echo $result['id']; ?>"/>
    ...
    <tr>
      <td></td>
        <td>
        <input type="submit" name="update" value="Add student"/>
...
<form action="" method="post">
 ...
 <table>
    ...
    <tr>
      <td></td>
        <td>
        <input type="submit" name="create" value="Add student"/>
...
<p><span style="margin-left: 300px"><b>Student List Table</b></span></p>
</section>
...
?>
 ...
 || <?php echo "<a href='index.php?action=delete&id=".$value['id']."' onClick='return confirm(\"Are You Want to Delete Data..\")'> Delete</a>";?>
            </td>
